...
import com.mtsmda.souvenir.spring.validation.validators.ValuteCodeValidator;
...
public @interface ValuteCodeConstraint {
    ...
    String message() default "{com.mtsmda.souvenir.spring.validation.validators.constraints.ValuteCodeConstraint.message}";
