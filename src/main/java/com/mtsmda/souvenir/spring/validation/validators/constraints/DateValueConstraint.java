...
import com.mtsmda.souvenir.spring.validation.validators.DateValueValidator;
...
public @interface DateValueConstraint {
    ...
    String message() default "{com.mtsmda.souvenir.spring.validation.validators.constraints.DateValueConstraint.message}";
